...
public class MapLayoutManagerStepThrough : MonoBehaviour
{
    ...
    private void CreateTreasureRooms()
    {
        ...
        List<RoomManager> subList =
            pathFromEntranceToExitSiblings.GetRange(0, pathFromEntranceToExitSiblings.Count - 1);
    ...
    private void PositionRoomInCorrectDirection(int direction, RoomManager newRoomManager, RoomManager currRoom)
    {
        ...
        switch (direction)
        {
            ...
            case (0):
                ...
                newRoom.transform.position = new Vector3(newRoom.transform.position.x - diffX,
                    newRoom.transform.position.y - diffY, 0);
